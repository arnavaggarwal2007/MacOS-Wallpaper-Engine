...
### Naming rule — Deskface vs Personal Wallpaper Engine

The app ships to users as **Deskface**. `Personal Wallpaper Engine` is the internal name only.
...
**Name:** Deskface (user-facing) / Personal Wallpaper Engine (internal)
